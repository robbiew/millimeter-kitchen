...
> gives every surface a named finish. AI-driven variations and the full
> purchase pack are planned but not built. The catalog's dimensions come from
...
src/mmk/              the package: units, io, room, catalog, model, rules, draw, scene, gltf, finishes, bom, cli

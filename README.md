...
> through an MCP server whose every change is validator-gated. The full
> purchase pack is planned but not built. The catalog's dimensions come from
...
src/mmk/              the package: units, io, room, catalog, model, rules, draw, scene, gltf, finishes, bom, edit, tools, mcp_server, cli

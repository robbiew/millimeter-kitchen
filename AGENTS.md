...
src/mmk/     the package: units, io, findings, room, catalog, model, rules, draw, scene, gltf, finishes, bom, edit, export, purchase, reconcile, planner_import, tools, mcp_server, cli

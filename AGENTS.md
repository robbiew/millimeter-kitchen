...
src/mmk/     the package: units, io, findings, room, catalog, model, rules, draw, scene, gltf, finishes, textures, ikea_models, bom, edit, export, review, purchase, reconcile, planner_import, tools, mcp_server, cli

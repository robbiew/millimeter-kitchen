...
- A line without an article number cannot be reconciled. The fix is a verified
  catalog entry (`tools/scrape_sektion.py`), never a guessed number.
...
src/mmk/     the package: units, io, findings, room, catalog, model, rules, draw, scene, gltf, finishes, bom, edit, export, purchase, reconcile, tools, mcp_server, cli

...
- Materials in phase 3 are flat colors keyed by catalog front series. Phase 4
  replaces them with real finishes; keep the material name as the key.
...
catalog/     SEKTION catalog, generated by tools/build_catalog_seed.py (never hand-edit)
examples/    one room, one kitchen that fits, six that do not (generated by tools/make_fixtures.py)
src/mmk/     the package: units, io, findings, room, catalog, model, rules, draw, scene, gltf, cli
